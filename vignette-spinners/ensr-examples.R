...
#' Model error that is lower by 0.1\% at the expense of 3 additional parameters
#' may or may not be appropriate for a given project.
#'
# /*
...
#'
#' And the preferable models, determined by minimizing the mean cross validation
#' error are:
...
#'
#' From the looks of the graphic the multinomial fits with either 9 non-zero
#' coefficients for the ungrouped model, or 14 non-zero coefficients for the
#' grouped model, are preferable.
#'
#' For **a** comparison of the results let's look at the models with the lowest
...
#'
#' Let's look at the coefficients for the models, starting with the three
#' univariate models
cbind(
